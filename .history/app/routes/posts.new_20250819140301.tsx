...
import { getUserIdentifier, generateGuestNumber, generateGuestEmail } from "~/utils/guestUtils";
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  // Handle guest users - generate guest number if no name/email provided
  ...
  if (!finalAuthorName || !finalAuthorEmail) {
    ...
    finalAuthorName = finalAuthorName || guestNumber;
    finalAuthorEmail = finalAuthorEmail || generateGuestEmail(guestNumber);
  }
