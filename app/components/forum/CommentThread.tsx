...
export default function CommentThread({
  ...
  const isSubmittingEdit = navigation.state === "submitting" && 
    navigation.formData?.get("intent") === "edit_comment";
        ...
        `}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4">
                ...
                {canEditComment(comment) && isAuthenticated && (
                  ...
                  >
                    {editCommentId === comment.id ? 'Cancel Edit' : 'Edit'}
                  </button>
                )}
          ...
          {editCommentId === comment.id && (
            <div className="mt-4 p-4 bg-amber-50 rounded-lg border border-amber-200">
              <h4 className="text-sm font-medium text-slate-900 mb-3">Edit Comment</h4>
              <Form method="post" className="space-y-3">
                <input type="hidden" name="intent" value="edit_comment" />
                <input type="hidden" name="commentId" value={comment.id} />
                <input type="hidden" name="authorEmail" value={comment.author_email} />
